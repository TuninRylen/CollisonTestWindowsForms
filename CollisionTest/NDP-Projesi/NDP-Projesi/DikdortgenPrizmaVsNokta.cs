...
{
    public partial class DikdortgenPrizmaVsNokta : Form
    {
        ...
        public DikdortgenPrizmaVsNokta()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                label9.Text = carpismalar.NoktaVsDPrizma(nokta, dPrizması);

                if (carpismalar.NoktaVsDPrizma(nokta, dPrizması) == "Çarpışma Vardır")
                {
