...
{
    public partial class DuzlemVsSilindir : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                label9.Text = carpismalar.DuzlemVsSilindir(duzlem, silindir);

                if (carpismalar.DuzlemVsSilindir(duzlem, silindir) == "Çarpışma Vardır")
                {
